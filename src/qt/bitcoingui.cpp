...
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/xgravity"));
    setWindowIcon(QIcon(":icons/xgravity"));
#else
...
void BitcoinGUI::createActions(int nQtStyle) {
    ...
    toggleHideAction = new QAction(QIcon(":/icons/xgravity"), tr("&Show / Hide"), this);
    ...
    aboutAction = new QAction(QIcon(":/icons/xgravity"), tr("&About Trezarcoin"), this);
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/xgravity_testnet"));
            setWindowIcon(QIcon(":icons/xgravity_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/xgravity_testnet"));
#endif
            if(trayIcon)
            {
