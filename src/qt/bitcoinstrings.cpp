...
QT_TRANSLATE_NOOP("trz-core", "Send command to -server or xgravityd"),
...
QT_TRANSLATE_NOOP("trz-core", "Specify configuration file (default: xgravity.conf)"),
...
QT_TRANSLATE_NOOP("trz-core", "Specify pid file (default: xgravityd.pid)"),
