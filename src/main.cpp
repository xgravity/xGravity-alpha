...
const uint nBaseTargetSpacing = 20;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees) {
    ...
    if(nHeight > 10) nSubsidy =  * COIN;
	if(nHeight > 2000) nSubsidy = 250 * COIN;
	if(nHeight > 10000) nSubsidy = 50 * COIN;
	if(nHeight > 20000) nSubsidy = 250 * COIN;
	if(nHeight > 40000) nSubsidy = 150 * COIN;
	if(nHeight > 60000) nSubsidy = 50 * COIN;
	if(nHeight > 80000) nSubsidy = 50 * COIN;
	if(nHeight > 100000)  nSubsidy = 25 * COIN;

	
    if(nHeight > 1200000) nSubsidy >>= ((nHeight - 1) / 2306400);
...
int64 GetProofOfStakeReward(int nHeight, int64 nFees) {
	...
	if(nHeight > 2000)  nSubsidy = 1000 * COIN;
	if(nHeight > 10000)  nSubsidy = 1500 * COIN;
	if(nHeight > 15000)  nSubsidy = 7500 * COIN;
	if(nHeight > 20000)  nSubsidy = 2500 * COIN;
	if(nHeight > 40000)  nSubsidy = 3500 * COIN;
	if(nHeight > 60000)  nSubsidy = 1000 * COIN;
	if(nHeight > 80000)  nSubsidy =  500 * COIN;
	if(nHeight > 100000)  nSubsidy = 50 * COIN;
